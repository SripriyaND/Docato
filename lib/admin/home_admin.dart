import 'package:docato/admin/add_food.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        child: Column(
          children: [
            Center(child: Text("Home Admin", style: AppWidget.headerTextFeildStyle(),),),
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Row(children: [
                      ...
                      child: Image.asset("images/delicious.jpg", height: 100, width: 100, fit: BoxFit.cover,),),
                  SizedBox(width: 30.0,) ,
